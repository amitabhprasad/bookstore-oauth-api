module github.com/amitabhprasad/bookstore-app/bookstore-oauth-api

go 1.17

require (
	github.com/amitabhprasad/bookstore-util-go v0.0.0-20220321005323-784862b0857c // indirect
